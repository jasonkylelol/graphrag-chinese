...
async def run_extract_entities(
    ...
    extraction_continue_prompt = args.get("extraction_continue_prompt", None)
    extraction_loop_prompt = args.get("extraction_loop_prompt", None)
    ...
    extractor = GraphExtractor(
        ...
        continue_prompt=extraction_continue_prompt,
        loop_prompt=extraction_loop_prompt,
