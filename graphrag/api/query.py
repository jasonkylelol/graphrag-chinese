...
def global_search_streaming(
    ...
    no_data_answer = load_search_prompt(
...
def drift_search_streaming(
    ...
    primer_prompt = load_search_prompt(config.root_dir, config.drift_search.primer_prompt)
    primer_expand_query_prompt = load_search_prompt(config.root_dir, config.drift_search.primer_expand_query_prompt)
