...
async def global_search(
    ...
    no_data_answer = _load_search_prompt(
        config.root_dir, config.global_search.no_data_answer
    )
...
async def drift_search(
    ...
    primer_prompt = _load_search_prompt(config.root_dir, config.drift_search.primer_prompt)
    primer_expand_query_prompt = _load_search_prompt(config.root_dir, config.drift_search.primer_expand_query_prompt)
