...
class DRIFTSearchConfig(BaseModel):
    ...
    primer_prompt: str | None = Field(
        description="The drift search primer prompt to use.", default=None
    )

    primer_expand_query_prompt: str | None = Field(
        description="The drift search primer expand query prompt to use.", default=None
    )
