...
class GlobalSearchConfig(BaseModel):
    ...
    map_system_prompt: str = Field(
        description="The global search map_system_prompt.",
        default=""
    )
    reduce_system_prompt: str = Field(
        description="The global search reduce_system_prompt.",
        default=""
    )
    general_knowledge_inclusion_prompt: str = Field(
        description="The global search general_knowledge_inclusion_prompt.",
        default=""
    )
    no_data_answer: str = Field(
        description="The global search no_data_answer.",
        default=""
    )
